...
public final class TornFcaUi {
    ...
    public static void header(Activity a,LinearLayout r,String backLabel,String title,String subtitle){
        ...
        // Chat is intentionally not injected into every screen. The single normal entry point lives under Faction.
        // Inside the chat destination itself, keep one explicit switch to Torn's real foreground chat experiment.
