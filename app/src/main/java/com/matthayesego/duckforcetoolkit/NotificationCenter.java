...
public final class NotificationCenter {
    ...
    private static String channel(String type){String t=type==null?"":type.toLowerCase(java.util.Locale.US);if("war".equals(t))return CH_WAR;if("oc".equals(t)||"chain".equals(t))return CH_OC_CHAIN;if("faction".equals(t)||"announcement".equals(t)||"banking".equals(t))return CH_FACTION;if("chat".equals(t))return CH_CHAT;return CH_PERSONAL;}
}
