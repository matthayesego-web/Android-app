...
public final class AppSettingsStore {
    ...
    public static boolean categoryEnabled(Context c,String type){if(!notificationsEnabled(c))return false;String t=type==null?"":type.toLowerCase(java.util.Locale.US);if("war".equals(t))return warAlerts(c);if("oc".equals(t))return ocAlerts(c);if("chain".equals(t))return chainAlerts(c);if("banking".equals(t))return bankingAlerts(c);if("faction".equals(t)||"announcement".equals(t))return factionAlerts(c);if("chat".equals(t))return chatAlerts(c);return personalAlerts(c);}
