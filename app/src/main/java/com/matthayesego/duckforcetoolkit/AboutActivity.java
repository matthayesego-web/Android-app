...
public class AboutActivity extends Activity {
    ...
    private void render(){
        ...
        TornFcaUi.add(this,r,TornFcaUi.card(this,"FACTION COMPANION","Built for faction life","TornFCA brings your personal faction day, training, resources, war participation, OC, chain, community and permission-aware leadership workflows into one focused Android companion. It complements Torn rather than replacing it.",TornFcaUi.GOLD));
        TornFcaUi.add(this,r,TornFcaUi.card(this,"PRIVACY","Your Torn API key","A Limited Access Torn API key is recommended. The key stays session-only unless you explicitly choose encrypted 7, 30 or 90 day device retention. TornFCA does not store it in plaintext.",TornFcaUi.GREEN));

        String legalStatus=LegalAcceptanceStore.hasAcceptedCurrent(this)?"Current Privacy Policy, Terms & Conditions and EULA have been acknowledged on this device.":"The current legal version has not yet been acknowledged on this device.";
        ...
        TornFcaUi.add(this,r,TornFcaUi.card(this,"INTEGRATIONS","Third-party intelligence","FFScouter and TornStats are optional separate services. TornFCA contacts them only after you explicitly opt in after reviewing their terms/data policy.",TornFcaUi.BLUE));
