...
/**
 * TornFCA launcher shim. v0.9.35 routes the side-by-side beta into the repaired command surface.
...
public class AccessGateActivity extends Activity {
    @Override protected void onCreate(Bundle savedInstanceState){
        ...
        if(BuildConfig.APPLICATION_ID.endsWith(".beta")){BetaSurfacePolish.install(getApplication());BetaGaugeLiveData.install(getApplication());}
