...
public class PremiumPreviewActivity extends Activity {
    ...
    private void render(){
        ...
        TornFcaUi.add(this,r,TornFcaUi.card(this,"EXTENDED ACTIVITY","30-day faction review","Free leadership gets the useful 7-day faction-log view. Premium extends the same tracker to 14/30 days for deeper participation review without making the core tracker paid-only.",TornFcaUi.GOLD));
