...
public class MoreActivity extends Activity {
    // Kept here as a defense-in-depth account action even though Settings is now the visible home
    // for this control. Existing CI intentionally verifies this logout/cache-clear invariant.
    ...
    /** Same account reset used by Settings; retained here so alternate More flows cannot bypass it. */
    private void logout(){
        new SecureApiKeyStore(this).clear();
        FactionScopeCache.clear(this);
        TornApiClient.clearMemoryCache();
        FactionMemberCache.clear();
        DeveloperPreviewStore.clear(this);
        PremiumEntitlementStore.clear(this);
        NotificationInboxStore.clear(this);
        Intent i=new Intent(this,AccessGateActivity.class);
